...
class About26Scope < Neo::Koan
  ...
  def test_bare_bones_class_names_assume_the_current_scope
    assert_equal true, About26Scope::String == String
  end
  ...
  def test_constants_can_be_looked_up_explicitly
    assert_equal true, PI == About26Scope.const_get("PI")
    assert_equal true, MyString == About26Scope.const_get("MyString")
  end
